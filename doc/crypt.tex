...
\index{ed25519\_sign}
\begin{verbatim}
int ed25519_sign(const  unsigned char *msg,
                        unsigned long  msglen,
                        unsigned char *sig,
                        unsigned long *siglen,
...
\begin{verbatim}
int ed25519_verify(const  unsigned char *msg,
                          unsigned long  msglen,
                   const  unsigned char *sig,
                          unsigned long  siglen,
                                    int *stat,
...
A release of the library contains the amalgamation in the path \texttt{pre_gen/tomcrypt_amalgam.c}.
