...
\subsection{File--API}
To process files two helper functions are provided.
...
The \textit{gcm\_file} function works with filenames whereas the \textit{gcm\_filehandle} function works with \textit{FILE} handles.

In case of an error in either of both functions, possibly written data is zero'ed and possibly created files are removed again.
