...
# XXX-HACK
CFLAGS += -DLTM_DESC -DUSE_LTM -I../libtommath
EXTRALIBS += -ltommath -L../libtommath
...
src/encauth/ocb/ocb_add_aad.o src/encauth/ocb/ocb_decrypt.o src/encauth/ocb/ocb_decrypt_last.o \
src/encauth/ocb/ocb_decrypt_verify_memory.o src/encauth/ocb/ocb_done.o src/encauth/ocb/ocb_encrypt.o \
src/encauth/ocb/ocb_encrypt_authenticate_memory.o src/encauth/ocb/ocb_encrypt_last.o \
src/encauth/ocb/ocb_init.o src/encauth/ocb/ocb_int_aad_add_block.o \
src/encauth/ocb/ocb_int_calc_offset_zero.o src/encauth/ocb/ocb_int_ntz.o \
src/encauth/ocb/ocb_int_xor_blocks.o src/encauth/ocb/ocb_test.o src/hashes/chc/chc.o \
...
src/misc/error_to_string.o src/misc/pk_get_oid.o src/misc/pkcs5/pkcs_5_1.o src/misc/pkcs5/pkcs_5_2.o \
...
src/pk/asn1/der/utf8/der_length_utf8_string.o src/pk/dh/dh.o src/pk/dsa/dsa_decrypt_key.o \
