...
int ocb_encrypt_last(ocb_state *ocb, const unsigned char *pt, unsigned long ptlen, unsigned char *ct);
int ocb_decrypt_last(ocb_state *ocb, const unsigned char *ct, unsigned long ctlen, unsigned char *pt);
int ocb_add_aad(ocb_state *ocb, const unsigned char *aad, unsigned long aadlen);
int ocb_done(ocb_state *ocb, unsigned char *tag, unsigned long *taglen);
...
int ocb_int_aad_add_block(ocb_state *ocb, const unsigned char *aad_block);
void ocb_int_calc_offset_zero(ocb_state *ocb, const unsigned char *nonce, unsigned long noncelen);
int ocb_int_ntz(unsigned long x);
void ocb_int_xor_blocks(unsigned char *out, const unsigned char *block_a, const unsigned char *block_b, unsigned long block_len);
