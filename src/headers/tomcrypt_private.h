...
#define MP_DIGIT_BIT                 ltc_mp_bits_per_digit()

/* some handy macros */
#define mp_name()                    ltc_mp_name()
...
#define mp_sqrtmod_prime_support()   ltc_mp_sqrtmod_prime_support()
#define mp_sqrtmod_prime(a, b, c)    ltc_mp_sqrtmod_prime(a, b, c)
#define mp_div(a, b, c, d)           ltc_mp_mpdiv(a, b, c, d)
#define mp_div_2(a, b)               ltc_mp_div_2(a, b)
#define mp_mod(a, b, c)              ltc_mp_mpdiv(a, b, NULL, c)
#define mp_mod_d(a, b, c)            ltc_mp_modi(a, b, c)
#define mp_gcd(a, b, c)              ltc_mp_gcd(a, b, c)
#define mp_lcm(a, b, c)              ltc_mp_lcm(a, b, c)

#define mp_rsa_me(a, b, c, d, e, f)  ltc_mp_rsa_me(a, b, c, d, e, f)
...
#define mp_ecc_ptmul(a, b, c, d, e, f) ltc_mp_ecc_ptmul(a, b, c, d, e, f)
#define mp_ecc_ptadd(a, b, c, d, e, f) ltc_mp_ecc_ptadd(a, b, c, d, e, f)
#define mp_ecc_ptdbl(a, b, c, d, e)  ltc_mp_ecc_ptdbl(a, b, c, d, e)
#define mp_ecc_map(a, b, c)          ltc_mp_ecc_map(a, b, c)
#define mp_ecc_mul2add_support()     ltc_mp_ecc_mul2add_support()
#define mp_ecc_mul2add(a, b, c, d, e, f, g) ltc_mp_ecc_mul2add(a, b, c, d, e, f, g)
...
#define mp_rand(a, b)                ltc_mp_rand(a, b)
