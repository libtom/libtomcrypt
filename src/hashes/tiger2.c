/* LibTomCrypt, modular cryptographic library -- Nick Brighten */
...
/**
 @file tiger2.c
 Tiger hash function, Nick Brighten
 */
...
/**
 ...
 @return CRYPT_OK if successful
 */
HASH_PROCESS(tiger2_process, s_tiger_compress, tiger2, 64)
